...
Sources:
    CIS007
Target tables:
    encuesta_violencia_sexual_2017
"""
...
RAW_SAV_PATH = Path("data") / "raw" / "CIS" / "CIS007-PercepciónSocialViolenciaSexual" / "3182.sav"
CLEAN_CSV_PATH = Path("data") / "clean" / "percepcion_social" / "encuesta_violencia_sexual_2017.csv"
