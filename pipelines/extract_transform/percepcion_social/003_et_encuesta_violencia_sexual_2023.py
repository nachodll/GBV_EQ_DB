...
Sources:
    CIS006
Target tables:
    encuesta_violencia_sexual_2023
"""
...
RAW_SAV_PATH = Path("data") / "raw" / "CIS" / "CIS006-ViolenciaSexualContraMujeres" / "3393.sav"
CLEAN_CSV_PATH = Path("data") / "clean" / "percepcion_social" / "encuesta_violencia_sexual_2023.csv"
...
def main():
    try:
        ...
        df_json["codigo_estudio"] = df["ESTUDIO"].astype(int).astype(str)
        df_json["fecha"] = "20-01-2023"
