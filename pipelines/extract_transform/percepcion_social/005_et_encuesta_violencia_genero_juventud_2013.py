...
Sources:
    CIS008
Target tables:
    encuesta_violencia_genero_juventud_2013
"""
...
RAW_SAV_PATH = Path("data") / "raw" / "CIS" / "CIS008-PercepciónSocialViolenciaGéneroAdolescenciaYJuventud" / "2992.sav"
CLEAN_CSV_PATH = Path("data") / "clean" / "percepcion_social" / "encuesta_violencia_genero_juventud_2013.csv"
