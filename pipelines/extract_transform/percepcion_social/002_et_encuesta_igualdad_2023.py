...
RAW_SAV_PATH = Path("data") / "raw" / "CIS" / "CIS005-PercepcionesIgualdadHombresMujeres" / "3428.sav"
CLEAN_CSV_PATH = Path("data") / "clean" / "percepcion_social" / "encuesta_igualdad_2023.csv"
