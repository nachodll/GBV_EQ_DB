...
RAW_XLSX_PATH = Path("data") / "raw" / "MINCIU" / "MINCIU002-EgresadosUniversidad.xlsx"
CLEAN_CSV_PATH = Path("data") / "clean" / "educacion_juventud" / "egresados_universidad.csv"
...
def main():
    try:
        ...
        df["egresados"] = apply_and_check(df["egresados"], normalize_positive_integer)
