...
SCRIPTS: List[Path] = [
    ...
    ET_SCRIPTS_DIR / "demografia" / "005_et_tasa_divorcialidad_edad_sexo.py",
    ET_SCRIPTS_DIR / "demografia" / "011_et_tasa_bruta_divorcialidad_comunidades.py",
    ET_SCRIPTS_DIR / "demografia" / "012_et_tasa_bruta_divorcialidad_provincias.py",
    ...
    ET_SCRIPTS_DIR / "politicas_publicas_igualdad_violencia" / "003_et_centros_acogida_emergencia.py",
    ET_SCRIPTS_DIR / "percepcion_social" / "001_et_barometros_generales.py",
    ET_SCRIPTS_DIR / "percepcion_social" / "002_et_encuesta_igualdad_2023.py",
    ET_SCRIPTS_DIR / "percepcion_social" / "003_et_encuesta_violencia_sexual_2023.py",
    ...
    ET_SCRIPTS_DIR / "economia_laboral" / "001_et_tasa_actividad_paro_empleo_provincias.py",
    ET_SCRIPTS_DIR / "economia_laboral" / "002_et_riesgo_pobreza_exclusion.py",
    ET_SCRIPTS_DIR / "economia_laboral" / "003_et_tasa_paro_comunidades.py",
    ET_SCRIPTS_DIR / "seguridad_criminalidad" / "001_et_tasas_homicidios_criminalidad.py",
    ET_SCRIPTS_DIR / "seguridad_criminalidad" / "002_et_delitos_sexuales.py",
]
