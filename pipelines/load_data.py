...
TABLES_TO_LOAD: Dict[Path, Optional[Callable[[Connection, pd.DataFrame], None]]] = {
    ...
    CLEAN_DATA_DIR / "violencia_genero" / "denuncias_vg_presentadas.csv": None,
    CLEAN_DATA_DIR / "violencia_genero" / "infracciones_penales_inputadas_vg.csv": None,
    CLEAN_DATA_DIR / "violencia_genero" / "encuesta_europea_2022.csv": None,
    ...
    CLEAN_DATA_DIR / "demografia" / "matrimonios_homosexuales.csv": None,
    CLEAN_DATA_DIR / "demografia" / "tasa_divorcialidad_edad_sexo.csv": None,
    CLEAN_DATA_DIR / "demografia" / "tasa_bruta_divorcialidad_comunidades.csv": None,
    CLEAN_DATA_DIR / "demografia" / "tasa_bruta_divorcialidad_provincias.csv": None,
    ...
    CLEAN_DATA_DIR / "demografia" / "uso_tiempo.csv": None,
    ...
    CLEAN_DATA_DIR / "igualdad_formal" / "mujeres_cargos_autonomicos.csv": None,
    CLEAN_DATA_DIR / "educacion_juventud" / "matriculados_educacion_no_universitaria.csv": None,
    CLEAN_DATA_DIR / "educacion_juventud" / "matriculados_universidad.csv": None,
    ...
    CLEAN_DATA_DIR / "educacion_juventud" / "nivel_formacion.csv": None,
    ...
    CLEAN_DATA_DIR / "politicas_publicas_igualdad_violencia" / "institutos_mujer.csv": None,
    CLEAN_DATA_DIR / "politicas_publicas_igualdad_violencia" / "centros_acogida_emergencia.csv": None,
    CLEAN_DATA_DIR / "percepcion_social" / "barometros_generales.csv": None,
    CLEAN_DATA_DIR / "percepcion_social" / "encuesta_igualdad_2023.csv": None,
    CLEAN_DATA_DIR / "percepcion_social" / "encuesta_violencia_sexual_2023.csv": None,
    ...
    CLEAN_DATA_DIR / "economia_laboral" / "tasa_actividad_paro_empleo_provincias.csv": None,
    CLEAN_DATA_DIR / "economia_laboral" / "tasa_paro_comunidades.csv": None,
    CLEAN_DATA_DIR / "economia_laboral" / "riesgo_pobreza_exclusion.csv": None,
    CLEAN_DATA_DIR / "seguridad_criminalidad" / "tasas_homicidios_criminalidad.csv": None,
    CLEAN_DATA_DIR / "seguridad_criminalidad" / "delitos_sexuales.csv": None,
}
