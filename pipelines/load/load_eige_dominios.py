...
def load_eige_dominios(conn: Connection, df: pd.DataFrame) -> None:
    """Load eige_dominios table from a DataFrame."""
    ...
    # Insert into table
    df.to_sql("eige_dominios", schema="igualdad_formal", con=conn, if_exists="append", index=False)
